...
export function CardBackCarousel({ 
  ...
  const getCardStyle = (index: number) => {
    ...
    const scale = absOffset > 2 ? 0 : 1 - absOffset * 0.15;
          ...
          {baseDesigns.map((design, index) => {
            ...
            return (
              <motion.div
                ...
                onClick={() => !isDragging && !isCurrent && navigateTo(index)}
                style={{ transformStyle: "preserve-3d", zIndex: cardStyle.zIndex }}
